...
# SidekiqBatch#attempt_completion! is the design's single race-safety
# claim: two workers completing the last two jobs simultaneously must
# result in exactly ONE fired callback.
#
# Fake-mode single-threaded tests cannot honestly prove this — the
# correctness lives in Postgres's row-level locking semantics on the
# UPDATE.
